    ...
    return (
        <section className="py-24 px-4">
            <div className="container m-auto">
                ...
                <h2 className="text-6xl font-medium mt-6 text-center max-w-xl m-auto">Questions? We&apos;ve got <span className="text-lime-400">answers</span></h2>
                <div className="mt-12 flex flex-col gap-6 max-w-xl m-auto">
                    {faqs.map((faq, faqIndex) => (
                        <div key={faq.question} className="bg-neutral-900 border border-white/10 rounded-2xl p-6">
